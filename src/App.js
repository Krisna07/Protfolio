...
import { FaCss3, FaFileSignature, FaHtml5, FaPalette, FaPenNib, FaPhoneAlt, FaRProject, FaReact } from "react-icons/fa"
...
function App() {
  ...
  const tabStyle = "preventSelect font-semibold leading-[120%] text-[1rem] space-2 tracking-wide py-1 px-4 box-shadow rounded uppercase flex items-center gap-2 transition-all duration-[1s] hover:bg-gray-700 hover:text-white"
  const itemsStyle = "w-full grid grid-cols-[200px_80%] bg-gray-200"
  return (
