      ...
      >
        ...
        >
          <a
            ...
            href="./files/Resume.pdf" download="Krishna paudel_Resume.pdf"
          >
            Resume
          </a>
        </div>
        ...
        >
          <a className={`text-bold bg-red-500 px-2 py-1  rounded `} href="./files/Resume.pdf" download="Krishna paudel_Resume.pdf">Resume</a>
